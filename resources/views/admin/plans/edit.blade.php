            ...
            <div class="card-body">
                <form action="{{ route('admin.plans.update', $plan) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('price_monthly') is-invalid @enderror" 
                                       id="price_monthly" name="price_monthly" value="{{ old('price_monthly', $plan->price_monthly) }}" required>
                                @error('price_monthly')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('price_yearly') is-invalid @enderror" 
                                       id="price_yearly" name="price_yearly" value="{{ old('price_yearly', $plan->price_yearly) }}" required>
                                @error('price_yearly')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('max_users') is-invalid @enderror" 
                                       id="max_users" name="max_users" value="{{ old('max_users', $plan->max_users) }}" required>
                                @error('max_users')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('max_projects') is-invalid @enderror" 
                                       id="max_projects" name="max_projects" value="{{ old('max_projects', $plan->max_projects) }}" required>
                                @error('max_projects')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('max_monthly_hours') is-invalid @enderror" 
                                       id="max_monthly_hours" name="max_monthly_hours" value="{{ old('max_monthly_hours', $plan->max_monthly_hours) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('max_invoices_per_month') is-invalid @enderror" 
                                       id="max_invoices_per_month" name="max_invoices_per_month" value="{{ old('max_invoices_per_month', $plan->max_invoices_per_month) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('max_twilio_messages_per_month') is-invalid @enderror" 
                                       id="max_twilio_messages_per_month" name="max_twilio_messages_per_month" value="{{ old('max_twilio_messages_per_month', $plan->max_twilio_messages_per_month) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="time_tracking" name="time_tracking" value="1" 
                                           {{ old('time_tracking', $plan->has_time_tracking) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="invoicing" name="invoicing" value="1" 
                                           {{ old('invoicing', $plan->has_invoicing) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="client_portal" name="client_portal" value="1" 
                                           {{ old('client_portal', $plan->has_client_portal) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="maintenance_reports" name="maintenance_reports" value="1" 
                                           {{ old('maintenance_reports', $plan->has_maintenance_reports) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="advanced_reporting" name="advanced_reporting" value="1" 
                                           {{ old('advanced_reporting', $plan->has_advanced_reporting) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="api_access" name="api_access" value="1" 
                                           {{ old('api_access', $plan->has_api_access) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="white_label" name="white_label" value="1" 
                                           {{ old('white_label', $plan->has_white_label) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="priority_support" name="priority_support" value="1" 
                                           {{ old('priority_support', $plan->has_priority_support) ? 'checked' : '' }}>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                   id="sort_order" name="sort_order" value="{{ old('sort_order', $plan->display_order) }}">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.plans.show', $plan) }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
